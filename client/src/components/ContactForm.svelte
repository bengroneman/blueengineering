    ...
    <div class="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
        <div class="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
            <div class="max-w-lg mx-auto">
                <h2 class="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">Say hello</h2>
                ...
                <dl class="mt-8 text-base text-gray-500">
                    <div class="mt-6">
                        ...
                        <dd class="flex">
                            ...
                            <span class="ml-3"> (307) 349-2727 </span>
                        </dd>
                    </div>
                    <div class="mt-3">
                        ...
                        <dd class="flex">
                            ...
                            <span class="ml-3 underline decoration-sky-400"> create@blueengineering.dev </span>
                        </dd>
                    </div>
                </dl>
            </div>
