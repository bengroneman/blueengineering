...
<Hero>
    <h2 slot="title" class="pt-6">Blue Engineering.</h2>
    <div slot="content">
        <p class="mx-auto">I started Blue engineeing to help build community centered around technology<br>
        I work and live out of my home base in Lander Wyoming.<br>
        I spend a majority of my time working with non-profits, small businesses, and focus on delivering high-quality, user focused software.
        </p>
    </div>

    <button slot="cta" type="button" class="btn-primary mt-8">
        <a href="#projects" class="font-semibold" aria-labelledby="link to scroll to project section">Learn More</a>
    </button>
</Hero>
...
<div class="relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
        <div class="text-lg max-w-prose mx-auto">
            <h1>
                <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">About</span>
                <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Blue Engineering</span>
            </h1>
